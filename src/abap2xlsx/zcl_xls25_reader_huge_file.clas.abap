CLASS zcl_xls25_reader_huge_file DEFINITION
  PUBLIC
  INHERITING FROM zcl_xls25_reader_2007
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF t_cell_content,
        datatype TYPE zxls25_cell_data_type,
        value    TYPE zxls25_cell_value,
        formula  TYPE zxls25_cell_formula,
        style    TYPE zxls25_cell_style,
      END OF t_cell_content .
    TYPES:
      BEGIN OF t_cell_coord,
        row    TYPE zxls25_cell_row,
        column TYPE zxls25_cell_column_alpha,
      END OF t_cell_coord .
    TYPES:
      BEGIN OF t_cell.
    ...
    METHODS get_style
      IMPORTING
        !iv_index            TYPE any
      RETURNING
        VALUE(ev_style_guid) TYPE zxls25_cell_style
      RAISING
        lcx_not_found .
...
CLASS zcl_xls25_reader_huge_file IMPLEMENTATION.
  ...
  METHOD load_worksheet.
    ...
    TRY.
      ...
      CATCH lcx_not_found INTO lx_not_found.
        zcx_xls25=>raise_text( lx_not_found->error ).
    ENDTRY.
  ENDMETHOD.
