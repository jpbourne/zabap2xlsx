CLASS zcl_xls25_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF zxls25_sheet_title WITH DEFAULT KEY,
...
CLASS zcl_xls25_template_data IMPLEMENTATION.
