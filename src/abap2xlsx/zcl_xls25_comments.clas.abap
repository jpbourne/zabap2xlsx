CLASS zcl_xls25_comments DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !io_from TYPE REF TO zcl_xls25_comments OPTIONAL .
    METHODS get
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA comments TYPE REF TO zcl_xls25_collection .
ENDCLASS.



CLASS zcl_xls25_comments IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA: lo_comment  TYPE REF TO zcl_xls25_comment,
