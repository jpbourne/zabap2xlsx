...
TYPES: BEGIN OF ts_subtotal_rows,
         row_int       TYPE zxls25_cell_row,
         row_int_start TYPE zxls25_cell_row,
...
TYPES: BEGIN OF ts_styles,
         ...
         alignment TYPE zxls25_alignment,
...
TYPES: BEGIN OF ts_color_styles,
         guid_old  TYPE zxls25_cell_style,
         fontcolor TYPE zxls25_style_color_argb,
         fillcolor TYPE zxls25_style_color_argb,
         style_new TYPE REF TO zcl_xls25_style,
