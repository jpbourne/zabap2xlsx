CLASS zcl_xls25_autofilters DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_autofilter,
        ...
        autofilter TYPE REF TO zcl_xls25_autofilter,
...
CLASS zcl_xls25_autofilters IMPLEMENTATION.
  ...
  METHOD add.
    ...
    IF sy-subrc = 0.
      RAISE EXCEPTION TYPE zcx_xls25. " adding another autofilter to sheet is not allowed
    ENDIF.
