CLASS zcl_xls25_security DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA revisionspassword TYPE zxls25_revisionspassword .
    DATA workbookpassword TYPE zxls25_workbookpassword .
...
CLASS zcl_xls25_security IMPLEMENTATION.
